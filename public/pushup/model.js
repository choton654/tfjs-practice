...
function isPushUpPose(pose) {
  ...
  if (
    leftWrist.score >= scoreThreshold &&
    ...
    const wristsAboveShoulders = leftWrist.position.y > leftShoulder.position.y && rightWrist.position.y > rightShoulder.position.y;
